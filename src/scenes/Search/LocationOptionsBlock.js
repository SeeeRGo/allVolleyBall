...
class LocationOptionsBlock extends Component {
  render() {
    return (
      <View style={{width: SCREEN_WIDTH, height: SCREEN_HEIGHT*0.14}}>
        <Row extraStyles={{width: SCREEN_WIDTH * 0.75, justifyContent: 'space-around', marginTop: 10, marginBottom: 10}}>
        ...
        <Row extraStyles={{ justifyContent: 'space-around', marginTop: 10, marginBottom: 10}}>
          ...
          <Text style={{width: SCREEN_WIDTH * 0.25, textAlign: 'center', color: 'yellow', alignSelf: 'flex-end'}}>ВЫБРАТЬ</Text>
        </Row>
      </View>
    )
  }
